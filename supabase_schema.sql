...
-- Assignment submissions (employee submit + manager review).
-- Full column set — see submissions_schema.sql to migrate an existing table.
...
-- previous "Anyone" access model. Content and submissions are readable/
-- writable by anon (submissions: employees insert, managers read + review).
...
grant select, insert, update, delete on public.academies, public.modules, public.lessons, public.submissions to anon, authenticated;
